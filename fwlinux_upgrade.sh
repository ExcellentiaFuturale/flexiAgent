...
linux_upgrade() {
    ...
    # doesn't kill the 'fwlinux_upgrade.sh' process itself on stopping the fwagent process,
    # as today the 'fwlinux_upgrade.sh' is invoked by the fwagent on receiving
